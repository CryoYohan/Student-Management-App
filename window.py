...
class Window():
    ...
    def entryfieldsframe(self)->None:
        # ENTRY FIELDS FRAME
        self.frame2 = tk.Frame(self.root, highlightbackground='black', highlightthickness=1, relief='raised', bd=3)
    ...
    def displaytextframe(self):
        # TREE VIEW FRAME       
        self.frame4 = tk.Frame(self.root, bg='red',highlightbackground='red', highlightthickness=1, relief='sunken', bd=5)
        ...
        for i in range(1,len(self.FIELDHEADERS)+1): # add columns with a fixed width of 80
            self.textbox.column(i,anchor='center',width=80)  
        self.displayrecords()
